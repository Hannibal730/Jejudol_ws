...
: iMyAhrsPlus(port, baud_rate), Node("myahrs_ros2")
{
  ...
  linear_acceleration_stddev_ =
    this->declare_parameter<double>("linear_acceleration_stddev", 0.026831);
  angular_velocity_stddev_ =
    this->declare_parameter<double>("angular_velocity_stddev", 0.002428);
  magnetic_field_stddev_ =
    this->declare_parameter<double>("magnetic_field_stddev", 0.00000327486);
  orientation_stddev_ =
    this->declare_parameter<double>("orientation_stddev", 0.002143);
