...
# -*- coding: utf-8 -*-
"""
MaRRT Caution Pure Pursuit Node (ROS2)
...
class MaRRTCautionPurePursuit(Node):
    def __init__(self):
        super().__init__('rrt_caution_purepursuit')

        self.declare_parameter('wheelbase', 0.724)
        self.declare_parameter('lookahead_distatnce_caution', 2.0)
        ...
        # 퍼블리셔
        self.cmd_pub = self.create_publisher(Float32, '/auto_steer_angle_rrt_caution', 10)
        self.lookahead_marker_pub = self.create_publisher(Marker, '/rrt/caution_lookahead_point', 10)
